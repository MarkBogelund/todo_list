    ...
    <div className={`${positionStyle} flex items-start`}>
      {!isEditing ? (
        ...
        <textarea
          ...
          className={`${titleStyle} w-full h-full border-white border rounded-md px-2 py-1 outline-none text-white font-thin resize-none overflow-hidden bg-transparent box-border my-2`}
